...
const Analytics: React.FC<AnalyticsProps> = ({ appointments, role, salon, userId }) => {
  ...
  return (
    <div className="flex-1 bg-background-dark min-h-screen pb-40 lg:pb-12 no-scrollbar">
      ...
      <main className="px-3 sm:px-6 py-4 space-y-4 animate-fade-in no-scrollbar overflow-y-auto w-full max-w-full">
