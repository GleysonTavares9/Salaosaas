      ...
      <main className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-1.5">
            ...
            <input type="email" required placeholder="seu@email.com" className="w-full bg-surface-dark border border-white/5 rounded-2xl py-5 px-6 text-white text-sm outline-none focus:border-primary/50 transition-all shadow-inner" />
          </div>
